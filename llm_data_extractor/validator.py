...
def validate_answer(raw_answer: str, question: Question) -> Tuple[Any, bool, str]:
    ...
    try:
        ...
        if answer_type == AnswerType.BOOLEAN:
            return _validate_boolean(raw_answer, constraints)
        elif answer_type == AnswerType.ENUM:
            return _validate_enum(raw_answer, constraints)
        elif answer_type == AnswerType.INTEGER:
            return _validate_integer(raw_answer, constraints)
        elif answer_type == AnswerType.FLOAT:
            return _validate_float(raw_answer, constraints)
        elif answer_type == AnswerType.STRING:
            return _validate_string(raw_answer, constraints)
        elif answer_type == AnswerType.DATE:
            return _validate_date(raw_answer, constraints)
        elif answer_type == AnswerType.LIST:
            return _validate_list(raw_answer, constraints)
        else:
...
def _validate_boolean(raw_answer: str, constraints: dict) -> Tuple[bool, bool, str]:
...
def _validate_integer(raw_answer: str, constraints: dict) -> Tuple[int, bool, str]:
...
def _validate_float(raw_answer: str, constraints: dict) -> Tuple[float, bool, str]:
...
def _validate_date(raw_answer: str, constraints: dict) -> Tuple[datetime, bool, str]:
